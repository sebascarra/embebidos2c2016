...
//modificamos el codigo de prueba para darle mayor claridad
...
#define TICKRATE_HZ1 (TICKRATE_1000HZ)	/* 1000 ticks per second */
...
int main(void)
{
	...
	while (1) {
		...
		if (msLED_Flag == true) {
			msLED_Flag = false;
			Board_LED_Toggle(0); //led de la placa virgen = 0
			Board_LED_Toggle(1); //led rojo = 1
		}
	}
